...
export default function App() {
  ...
  // Lista de Pets recebendo o modoNoturno
  ...
  // Tela de Perfil (Onde fica o interruptor para ligar/desligar)
  ...
  const corBotaoBorda = modoNoturno ? '#1E1E1E' : '#FFF';
    ...
    <LinearGradient colors={coresFundo} style={styles.container}>
      ...
      <SafeAreaView style={{ flex: 1, justifyContent: 'space-between' }}>
        ...
        <View style={styles.areaLogo}>
          ...
          <Text style={styles.subtituloApp}>O diário inteligente do seu pet</Text>
        </View>

        {/* Cartão Branco vira Cartão Escuro no modoNoturno */}
        <View style={[styles.cardBranco, { backgroundColor: corCartao }]}>
          ...
          <Text style={[styles.textoBoasVindas, { color: corTextoSecundario }]}>Faça login ou crie uma conta para começar a cuidar do seu pet.</Text>

          <TouchableOpacity style={styles.botaoLogin} onPress={() => setTelaAtual('Login')}>
            <Text style={styles.textoBotaoLogin}>Entrar na minha conta</Text>
          </TouchableOpacity>

          <TouchableOpacity style={[styles.botaoCadastrar, { backgroundColor: corBotaoBorda }]} onPress={() => setTelaAtual('Cadastro')}>
...
const styles = StyleSheet.create({
  ...
  textoBotaoLogin: { color: '#FFF', fontSize: 18, fontWeight: 'bold' },
  botaoCadastrar: { width: '100%', height: 60, borderWidth: 2, borderColor: '#F86F03', borderRadius: 16, justifyContent: 'center', alignItems: 'center' },
